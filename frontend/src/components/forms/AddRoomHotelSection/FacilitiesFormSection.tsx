...
const FacilitiesFormSection = () => {
  ...
  return (
    <div>
        <h2 className='text-2xl font-bold mb-3 z-50'>Facilities</h2> 
        <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap:2 md:gap-3 bg-bleached-cedar-200  rounded p-6'>
