  ...
  return (
    <form onSubmit={handleSubmit} className=' -mt-8  p-3 bg-bleached-cedar-400 rounded shadow-md w-full grid grid-cols  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 items-center gap-2 '>
      ...
      <div className='flex gap-1'>
        <button className='w-2/3 bg-bleached-cedar-600 text-white h-full p-2 font-bold text-base'>
            Search
        </button>
        <button className='w-1/3 bg-red-600 text-white h-full p-2 font-bold text-base '>
            Clear
        </button>
      </div>
    </form>
